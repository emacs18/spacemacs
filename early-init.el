...
(let* ((default-directory (file-name-directory load-file-name))
  ...
  ;; suppress warning regarding package.el being loaded
  (setq straight-package--warning-displayed t)

  ;; See my/local-module-changed-p for documentation.
  ...
  ;; This started failing to load, because recipe was somehow changed to
  ;; https://git.savannah.gnu.org/git/emacs/nongnu.git which was huge repo with
  ;; no files! So I changed this back to original author. -kimr 4/1/2025
  (straight-override-recipe '(ws-butler :host github :repo "lewang/ws-butler"))

  ;; This was added recently. -kimr 7/10/2025
  (straight-override-recipe '(avy-jump-helm-line :host github :repo "sunlin7/avy-jump-helm-line"))

  ;; Got this from LAYERS.org. -kimr 5/15/2026
  ;; Not sure if this is needed, so comment out for now.
  ;; (straight-override-recipe '(window-purpose :host github :repo "bmag/emacs-purpose"))

  ;; (straight-override-recipe '(evil-org :host github :repo "hlissner/evil-org-mode.git"))

  ;; github-copilot depends on this.  However, I'm not sure whether this is needed.
  ;; (straight-override-recipe '(mcp :host github :repo "lizqwerscott/mcp.el"))
